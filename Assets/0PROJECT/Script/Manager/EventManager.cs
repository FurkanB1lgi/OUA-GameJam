...
public static class EventManager
{
    ...
    {
        if (eventTableDouble.ContainsKey(gameEvent) && eventTableDouble[gameEvent] != null)
    ...
    {
        if (eventTableTriple.ContainsKey(gameEvent) && eventTableTriple[gameEvent] != null)
    ...
    {
        if (eventTableFourth.ContainsKey(gameEvent) && eventTableFourth[gameEvent] != null)
